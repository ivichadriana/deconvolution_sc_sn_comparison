...
if __name__ == "__main__":
    ...
    for cell_type in cell_types:
        ...
        if os.path.exists(model_save_path):
            ...
            adata_sc_except_ct, adata_sn_except_ct = remove_diff_genes(
            ...
            model.save(
                f"{args.output_path}/scvi_NODEG_trained_model_NO{cell_type.replace(' ', '_')}",
                overwrite=True,
            )
    ...
    for cell_type in cell_types:
        ...
        if os.path.exists(model_save_path):
            ...
            # Save for deconvolution, reference and trained model.
            model.save(
                f"{args.output_path}/scvi_NODEG_notcond_trained_model_NO{cell_type.replace(' ', '_')}",
                overwrite=True,
            )
